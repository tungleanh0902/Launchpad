...
contract LaunchpadTest is Test {
    ...
    function test_clone_launchpad() public {
        Launchpad.VestingPeriod[] memory _vesting_periods = new Launchpad.VestingPeriod[](2);
        _vesting_periods[0] = Launchpad.VestingPeriod(1753013836, 1753023836);
        _vesting_periods[1] = Launchpad.VestingPeriod(1753033836, 1753043836);
        uint[] memory _vesting_percent = new uint[](2);
        _vesting_percent[0] = 5000;
        _vesting_percent[1] = 5000;
